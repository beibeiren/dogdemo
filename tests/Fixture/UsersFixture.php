...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-07-06 02:31:18',
                'modified' => '2018-07-06 02:31:18'
            ],
        ];
        parent::init();
    }
